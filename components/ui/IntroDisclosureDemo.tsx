...
const steps = [
  {
    ...
    media: {
      type: "image" as const,
      src: "https://i.pinimg.com/1200x/1f/4a/98/1f4a98b085f173236da8acb60709ae45.jpg",
...
export function IntroDisclosureDemo() {
  ...
  const [storageState, setStorageState] = useState<StorageState>(() => ({
    desktop: typeof window !== 'undefined' ? localStorage.getItem("feature_intro-demo") : null,
    mobile: typeof window !== 'undefined' ? localStorage.getItem("feature_intro-demo-mobile") : null,
  }))
    ...
    <div className="w-screen">
        ...
        {/* <div className="border-t p-4">
          ...
          >
            ...
            <CollapsibleContent className="gap-y-2">
