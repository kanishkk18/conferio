...
import { Modal, ModalBody, ModalContent, ModalHeader, ModalTitle } from "./animated-modal"
      ...
      {step.media ? (
        <div className="relative bg-black h-full w-full">
          <motion.div
            ...
            animate={controls}
            className="h-full w-full min-w-lg max-h-[700px]"
          >
    ...
    <div className="flex h-full flex-col max-w-2xl mx-auto">
      {isDesktop && (
        <div className="flex-1  px-2 py-3">
          <motion.div
            ...
            className="gap-y-2 flex flex-col justify-center items-center px-1"
          >
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          <div className="flex items-center gap-x-2 pb-4 px-4">
            <Checkbox
              id="skipNextTime"
  ...
  if (isDesktop) {
    return (
      <Modal open={open} onOpenChange={setOpen}>
        <ModalBody className="!w-screen !min-w-[65vw] !max-w-[65vw] !h-[75vh] !max-h-[75vh] !p-0 gap-0 overflow-hidden">
        <ModalContent
          className="!w-full !p-0"
          onKeyDown={handleKeyDown}
        >
          <ModalHeader className="p-6 space-y-2 bg-[#181818]">
            <ModalTitle>Feature Tour</ModalTitle>
            {showProgressBar && (
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerContent className="h-[95vh] max-h-[95vh] ">
        ...
        >
          <DrawerHeader className="text-left  pb-4 gap-y-4">
            {showProgressBar && (
              <Progress
                value={((currentStep + 1) / steps.length) * 100}
                className="mb-4"
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 gap-y-4 pb-32">
              {/* Step tabs */}
              ...
              {/* Preview */}
              <div className="relative w-screen ring-2 ring-border ring-offset-8 ring-offset-background rounded-lg overflow-hidden">
