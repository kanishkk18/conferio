...
function AccordionMenu({
  ...
  const [uncontrolledValue, setUncontrolledValue] = React.useState<string | undefined>(selectedValue);
  const isControlled = selectedValue !== undefined;
  const currentSelectedValue = isControlled ? selectedValue : uncontrolledValue;
  
  const setSelectedValue = React.useCallback((val: React.SetStateAction<string | undefined>) => {
