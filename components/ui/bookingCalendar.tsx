    ...
    <DayPicker
      ...
      classNames={{
        ...
        week_number_header: cn(
          "w-[--cell-size] select-none text-red-500",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full select-none p-0 dark:bg-[#333] rounded-lg text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
        ...
        today: cn(
          " text-accent-foreground rounded-lg data-[selected=true]:rounded-none",
