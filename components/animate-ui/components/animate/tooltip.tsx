...
function TooltipContent({
  ...
  return (
    <TooltipContentPrimitive
      className={cn(
        'z-50 w-fit bg-[#5C47CD] dark:bg-[#232323] text-[#EEEEEE] font-semibold rounded-md !border-none',
        className,
      )}
      {...props}
    >
      ...
      <TooltipArrowPrimitive
        className="!fill-[#5C47CD] dark:!fill-[#232323] size-3 data-[side='left']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  );
