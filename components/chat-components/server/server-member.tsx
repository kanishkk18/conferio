...
export const ServerMember = ({ member, server }: ServerMemberProps) => {
  ...
  return (
    <div className="!-gap-y-2 flex flex-col items-center -gap-y-2">
      <button type="button"
        onClick={onClick}
        className={cn(
          " rounded-md flex flex-col -gap-y-2 items-center w-fit hover:bg-neutral-900 hover:dark:bg-neutral-900 transition",
