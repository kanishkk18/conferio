...
export function ChatItem({
  ...
  const onMemberClick = () => {
    ...
    const serverId = pathParts[1]; // /servers/[serverId]/...
          ...
          {canEditMessage && (
            <ActionTooltip label="Edit">
              <Edit
                ...
                className="cursor-pointer ml-auto size-4text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
              />
            </ActionTooltip>
          )}
          <Dialog>
